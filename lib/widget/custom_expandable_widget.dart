...
class CustomeExpandableWidget extends StatelessWidget {
  final String curiculumTitle;
  final String totalVideoAmount;
  final String totalVideoRuntime;
  final List lectures;

  const CustomeExpandableWidget({Key? key,
  ...
  Widget build(BuildContext context) {
    var size = MediaQuery
        .of(context)
        .size;
    return ExpandableNotifier(child: Column(
      children: [
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 5.0,),
                        Text(
                          '$totalVideoAmount Lecture - $totalVideoRuntime total length',
                          style: TextStyle(
                            fontSize: 12.0,
                            color: secondary.withOpacity(0.5),
                          ),
                ...
                Column(children: List.generate(lectures.length, (index) {
                  return Padding(padding: const EdgeInsets.only(bottom: appPadding),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      const SizedBox(height: 5.0,),
                      Text('Runtime:  ${lectures[index]['runtime']}',
                      style: const TextStyle(
                        fontSize: 12,
                        color: grey
                      ),)
