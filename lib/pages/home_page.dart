...
import 'package:flutter_e_learning/datas/user_profile.dart';
import 'package:flutter_e_learning/theme/colors.dart';
import 'package:flutter_e_learning/theme/padding.dart';
import 'package:flutter_e_learning/widget/clipper.dart';
import 'package:flutter_e_learning/widget/custom_categories_button.dart';
import 'package:flutter_e_learning/widget/custom_category_card.dart';
import 'package:flutter_e_learning/widget/custom_course_card.dart';
import 'package:flutter_e_learning/widget/custom_heading.dart';
import 'package:flutter_e_learning/widget/custom_promotion_card.dart';
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const CustomTitle(title: "Feature Course"),
                  ],
                ),
              ),
            ],
                ...
                children: [
                  Row(
                    children: List.generate(CategoryJson.length, (index){
                      return Padding(padding: const EdgeInsets.only(left: 10, right: 10, top: 5, bottom: 5),
